...
export default function LandingSenseAI() {
  useEffect(() => {
    ...
    if (hash.includes('access_token')) {
      window.location.href = '/minha-conta' + hash
    }
  }, [])
  ...
  return (
    <div style={{ background: '#07070F', color: '#F0F0FF', fontFamily: "'Inter', system-ui, sans-serif", minHeight: '100vh' }}>
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(7,7,15,.85)', backdropFilter: 'blur(16px)', borderBottom: '1px solid rgba(255,255,255,.06)', padding: '0 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', height: 60, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <a href="/sense-app.html"
              style={{ background: 'rgba(255,255,255,.07)', border: '1px solid rgba(255,255,255,.12)', color: '#F0F0FF', textDecoration: 'none', padding: '8px 18px', borderRadius: 10, fontSize: 13, fontWeight: 700 }}>
              Entrar →
            </a>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '90px 24px 80px', textAlign: 'center' }}>
        <div style={{ fontSize: 12, fontWeight: 800, letterSpacing: '.08em', textTransform: 'uppercase', marginBottom: 16, background: 'linear-gradient(135deg,#10B981,#A855F7)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}>
          <div>
            ...
            <h2 style={{ fontSize: 'clamp(22px,3vw,34px)', fontWeight: 900, marginBottom: 20, lineHeight: 1.2 }}>
              Psicologia Organizacional + IA em um só produto
            </h2>
            <p style={{ fontSize: 14, color: 'rgba(240,240,255,.55)', lineHeight: 1.8, marginBottom: 28 }}>
              Criado por uma especialista em <strong style={{ color: '#F0F0FF' }}>Gestão de Pessoas e Psicologia Organizacional</strong>, o Essencial Sense AI combina a ciência do comportamento humano com inteligência artificial de última geração.
            </p>
          </div>
      ...
      <footer style={{ borderTop: '1px solid rgba(255,255,255,.06)', padding: '40px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', padding: '4px 0 20px' }}>
            <div style={{ fontSize: 13, fontWeight: 800, background: 'linear-gradient(135deg,#10B981,#A855F7)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Essencial Human Tech</div>
            <div style={{ fontSize: 11.5, color: 'rgba(240,240,255,.35)', marginTop: 2 }}>Transformando tecnologia em desenvolvimento humano</div>
          </div>
